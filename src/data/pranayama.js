...
export const TECHNIQUES = [
  ...
  // ---------- 5단계 · 활력 (고급·주의) ----------
  {
    ...
    timer: {
      ...
      restSec: 20,
      requireConsent: true,
      firstSessionRounds: 1, // 첫 세션은 1라운드로 제한 (지침: 초회 1~2분 이내)
    },
    cautions: [
      '공복(식후 3~4시간 이후)에 하세요.',
      '어지럽거나 숨이 가쁘면 즉시 중단하고 자연호흡으로 돌아옵니다.',
    ],
    // 뇌전증: 과호흡이 발작을 유발할 수 있음 / 역류성 식도염: 복부 수축이 위산 역류를 촉진
    contraindications: [
      '임신',
      '고혈압',
      '심장질환',
  ...
  },
  {
    ...
    timer: {
      ...
      restSec: 25,
      requireConsent: true,
      firstSessionRounds: 1, // 첫 세션은 1라운드로 제한
    },
    cautions: [
      '카팔라바티보다 강하므로 무리하지 마세요.',
      '공복(식후 3~4시간 이후)에 하세요.',
      '어지럽거나 숨이 가쁘면 즉시 중단하고 자연호흡으로 돌아옵니다.',
    ],
    contraindications: [
