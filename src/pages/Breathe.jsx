...
//
// 프리셋은 전부 무료다. 프리미엄으로 파는 것은 "커스텀 패턴"(초 단위 직접 설정)이지
// 기본 패턴이 아니다. 세션 중 속도 조절로 어차피 근처 값에 도달할 수 있어
// 프리셋만 잠그는 것은 앞뒤가 맞지 않는다. — docs/PRODUCT_STRATEGY.md 6-2
const PATTERNS = [
  ...
  { key: '4-4-4-4', label: '사각', phases: [4, 4, 4, 4], premium: false }, // 16초 · 분당 3.8회
  { key: '4-7-8-0', label: '수면', phases: [4, 7, 8, 0], premium: false }, // 19초 · 분당 3.2회
]
